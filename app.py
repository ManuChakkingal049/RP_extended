    ...
    with tab1:
        ...
        if scenario_type == "Uniform Run-off":
            ...
            with col1:
                ...
                retail_unstable_runoff = st.slider("Unstable Retail Run-off %", 0, 100, 20)
                corporate_runoff = st.slider("Corporate Deposit Run-off %", 0, 100, 40)
            
            with col2:
                wholesale_runoff = st.slider("Wholesale Funding Run-off %", 0, 100, 75)
        ...
        with st.spinner("Running simulation... This may take a moment."):
            try:
                ...
                engine = LiquidityEngine(
                    ...
                    scenario=st.session_state.scenarios[0],  # Use first scenario
